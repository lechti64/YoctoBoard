<nav aria-label="Pagination">
    <ul class="pagination pagination-sm">
        <li class="page-item <?php if ($this->pagePrevious < 1): ?>disabled<?php endif ?>">
            <a class="page-link"
               href="?application=forum&controller=<?php echo $this->forum->id; ?>&page=1"
        ...
        <li class="page-item <?php if ($this->pagePrevious < 1): ?>disabled<?php endif ?>">
            <a class="page-link"
               href="?application=forum&controller=<?php echo $this->forum->id; ?>&page=<?php echo $this->pagePrevious; ?>">Précédent</a>
        </li>
        ...
        <li class="page-item <?php if ($this->pageNext > $this->pagesNb): ?>disabled<?php endif ?>">
            <a class="page-link"
               href="?application=forum&controller=<?php echo $this->forum->id; ?>&page=<?php echo $this->pageNext; ?>">Suivant</a>
        </li>
        <li class="page-item <?php if ($this->pageNext > $this->pagesNb): ?>disabled<?php endif ?>">
            <a class="page-link"
               href="?application=forum&controller=<?php echo $this->forum->id; ?>&page=<?php echo $this->pagesNb; ?>"
